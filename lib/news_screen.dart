...
class _NewsScreenState extends State<NewsScreen> {
  ...
  Future<void> fetchNews() async {
    final response = await http.get(
      Uri.parse('https://newsapi.org/v2/everything?q=politics&apiKey=c903743fc0c742799bce6bb0f6b9890d'),
    );
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final imageUrl = news[index]['urlToImage'] ?? 'https://i.ibb.co/sm9qVfM/Free-Vector-Realistic-news-studio-background.jpg';
          final urlNews = news[index]['url'];
          final publishedAt = news[index]['publishedAt'];
